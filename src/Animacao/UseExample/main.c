...
void main()
{
	...
	animacao_loadSheet(animacao, tela, "../../images/sprites/spritesheet.png", 4, 4);
	animacao_setDefaultSprite(animacao, 0);
	animacao_setTamanhoTotal(animacao, 300, 300);
	animacao_setPosicao(animacao, 0, 0);
	animacao_start(animacao);

	animacao_loadSheet(direita, tela, "../../images/sprites/spritesheet.png", 4, 4);
	...
	animacao_loadSheet(esquerda, tela, "../../images/sprites/spritesheet.png", 4, 4);
	...
	animacao_loadSheet(baixo, tela, "../../images/sprites/spritesheet.png", 4, 4);
